...
if (!message.member.roles.has(`602821408216580097`) && !message.member.roles.has(`603688658654068736`)) return message.channel.send(`⚠ **|** Üzgünüm, yetkin yok.`)
    ...
    if (uye.roles.has(`598937072358785043`)) {
    let rol = message.guild.roles.find(e => e.id === '598937072358785043')
    let embed = new Discord.RichEmbed()
    .setColor(rol.hexColor)
    .setDescription(`<a:tik:605024713034563585> <@${uye.id}> üyesinden ${rol} rolü alındı.`)
    ...
    .setFooter(`Yetkili: ${message.author.tag}`)
    .setTimestamp()
    uye.addRole(`598937072358785043`)
    uye.removeRole(`612271671285383208`)
    message.delete()
    message.channel.send(embed)
