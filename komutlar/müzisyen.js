...
if (!message.member.roles.has(`602821408216580097`) && !message.member.roles.has(`603688658654068736`)) return message.channel.send(`⚠ **|** Üzgünüm, yetkin yok.`)
    ...
    let rol = message.guild.roles.find(e => e.id === '600034614207053826')
    let embed = new Discord.RichEmbed()
    .setColor(rol.hexColor)
    .setFooter(`${message.author.tag}`)
    .setTimestamp()
    .setDescription(`<@${uye.id}> üyesinden ${rol} rolü verildi. <a:tik:605024713034563585>`)
    uye.removeRole(``)
    uye.addRole(`600034614207053826`)
    message.delete()
